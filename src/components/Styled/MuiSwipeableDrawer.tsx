        ...
        sx: [
          (theme) => {
            ...
            return {
              ...
              borderTopRightRadius: anchor === 'top' || anchor === 'right' ? 0 : undefined,
              borderTopLeftRadius: anchor === 'top' || anchor === 'left' ? 0 : undefined,
              borderBottomRightRadius: anchor === 'bottom' || anchor === 'right' ? 0 : undefined,
              borderBottomLeftRadius: anchor === 'bottom' || anchor === 'left' ? 0 : undefined,
            };
          },
