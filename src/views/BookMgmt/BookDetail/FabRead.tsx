...
export type DetailFabReadProps = { hasRead?: boolean } & Pick<FabProps, 'onClick'>;

const DetailFabRead: FC<DetailFabReadProps> = forwardRef(({ hasRead, onClick, ...props }, ref) => {
  ...
  return (
    <Box
      ...
      ref={ref}
      {...props}>
      <Fab color={hasRead ? 'secondary' : 'primary'} variant="extended" onClick={onClick}>
        <Icon sx={{ mr: 1 }} />
